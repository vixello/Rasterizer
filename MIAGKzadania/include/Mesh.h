...
public:
    ...
    virtual void Draw(Rasterizer& r, unsigned int textureId, bool lightOn, unsigned int color1, unsigned int color2, unsigned int color3) const = 0;
...
protected:
    ...
    std::vector<Vector2> texCoords_; // Texture coordinates for each vertex
